...
```
                      분개장(vat)  분개장(일반)  카드미반영  총합계  분개장요약
정렬순서  손익분류   계정과목
1        매출      의료수입        6.9M       991.0M        0    998.0M    998.0M
                   보험의료수입      0         18.5M        0     18.5M     18.5M
2        매출원가  의약품비(즉시)  247.0M        0          0    247.0M    247.0M
3        판관비    복리후생비        0           0       5.6M      5.6M        0
                   급여              0        800.0M        0    800.0M    800.0M
...
```
