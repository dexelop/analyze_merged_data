...
| 02-2 | [기본_거래처추가_피벗](./02-2_기본_거래처추가_피벗.md) | 기본피벗 + 거래처 (분개장요약 내림차순) |
| 02-3 | [기본_거래처_증빙유형](./02-3_기본_거래처_증빙유형.md) | 기본피벗 + 거래처 + 증빙유형 (빈행 0 채움) |
...
| 01. 파생 컬럼 생성 | ✅ | |
| 02. 기본 피벗 분석 | ✅ | |
| 02-2. 기본_거래처추가_피벗 | ✅ | 거래처별 분개장요약 내림차순 |
| 02-3. 기본_거래처_증빙유형 | ✅ | 거래처+증빙유형, 빈행 0 채움 |
| 03. 거래처별 분석 | ✅ | TOP 10만 |
| 04. 증빙유형별 분석 | ✅ | |
| 05. 월별 추이 분석 | ✅ | |
| 06. 카드 현황 분석 | ✅ | |
| 07. 카드미반영 상세 | ✅ | |
| 08. 이상 거래 탐지 | ✅ | Z-score + 급증/급감 |
| 09. 출력 포맷 | ✅ | 타임스탬프 파일명 |
